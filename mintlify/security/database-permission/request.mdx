...
1. After submitting the request, there's an request issue created matched with the [custom approval](/change-database/approval/) you configured. Once the request is approved, the user will have the requested role.
