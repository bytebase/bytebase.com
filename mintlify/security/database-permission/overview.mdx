...
You can also pick out specific permissions to build [custom roles](/administration/custom-roles/). e.g. create a custom role that grants only the [EXPLAIN](/security/database-permission/explain/) permission.
