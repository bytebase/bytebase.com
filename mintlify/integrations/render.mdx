...
![render-database-connections](/content/docs/integrations/render/render-database-connections.webp)
...
![render-bytebase-create-instance](/content/docs/integrations/render/render-bytebase-create-instance.webp)
...
![render-bytebase-instance](/content/docs/integrations/render/render-bytebase-instance.webp)

So should the tables under the databases.

![render-bytebase-database](/content/docs/integrations/render/render-bytebase-database.webp)
