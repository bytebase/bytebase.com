...
![supabase-database-setting](/content/docs/integrations/supabase/supabase-database-setting.webp)
...
![supabase-sql-editor](/content/docs/integrations/supabase/supabase-sql-editor.webp)

### Step 3 - Add the Supabase database instance to Bytebase

Choose `PostgreSQL`, and copy the `Host`, `Port`, `User` and `Password` from the last two steps to the form and click "Create". See [Add an Instance](/get-started/step-by-step/add-an-instance) for more details.

![supabase-bytebase-create-instance](/content/docs/integrations/supabase/supabase-bytebase-create-instance.webp)
...
![supabase-bytebase-instance](/content/docs/integrations/supabase/supabase-bytebase-instance.webp)

So should the tables under the databases.

![supabase-bytebase-database](/content/docs/integrations/supabase/supabase-bytebase-database.webp)
