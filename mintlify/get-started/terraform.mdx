...
<Card title="Tutorial: Manage Databases in Bytebase with Terraform" icon="graduation-cap" href="/tutorials/manage-databases-in-bytebase-with-terraform" horizontal />
