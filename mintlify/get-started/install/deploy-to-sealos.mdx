...
If you run [Bytebase on Kubernetes](/get-started/self-host/#kubernetes), you need to prepare a Kubernetes cluster, PostgreSQL instance, storage driver, and ingress for external access.
