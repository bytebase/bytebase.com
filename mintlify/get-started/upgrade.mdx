...
```bash
# https://hub.docker.com/repository/docker/bytebase/bytebase/tags/3.8.0/sha256-29be3c651d4fc93c6aab37046b41128015a9be5d6f02b2490353962c469c5110
docker pull bytebase/bytebase:3.8.0@sha256:00b436855b08739aad02fd52e41b5d74c03db9c70c49ce5de42376347cd1403c
```

The docker image is built with [OpenContainers Annotations](https://specs.opencontainers.org/image-spec/annotations/):

```bash
docker inspect bytebase/bytebase:3.8.0 | jq -r '.[0].Config.Labels'
{
...
# Digest also works
docker inspect bytebase/bytebase:3.8.0@sha256:00b436855b08739aad02fd52e41b5d74c03db9c70c49ce5de42376347cd1403c | jq -r '.[0].Config.Labels'
{
...
- `org.opencontainers.image.version` is the release version, in the example, it corresponds to the [3.8.0 release branch](https://github.com/bytebase/bytebase/commits/release/3.8.0).
