...
SQL advisor runs automatic SQL checks when you create schema or data changes. On a specific issue page, the advisor will run automatically after creation:
