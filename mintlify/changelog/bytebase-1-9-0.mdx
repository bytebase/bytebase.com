...
- Support managing environment and instance via Terraform provider: [https://www.bytebase.com/docs/get-started/terraform](/get-started/terraform)
...
- Support managing with Supabase databases: [https://www.bytebase.com/docs/how-to/integrations/supabase](/how-to/integrations/supabase)

## 📰 Fresh Off the Press

- [How to Manage Database Access Control](https://www.bytebase.com/blog/how-to-manage-database-access-control)
