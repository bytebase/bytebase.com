---
title: Bytebase 3.10.1 - Sep 25, 2025
author: Adela
...
- Add project labels, up to 64 key–value pairs.
...
- Add option to switch [transaction mode](/change-database/transaction-mode) in Plan.
