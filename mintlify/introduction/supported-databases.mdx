...
| Feature            | [RBAC](/concepts/roles-and-permissions) | [Audit](/security/audit-log) | [Secret Manager](/get-started/instance/#use-secret-manager) | [Query Access](/security/database-permission/overview/) | [Masking](/security/data-masking/overview) | [Detect Drift](/change-database/drift-detection) |
| :----------------- | :-------------------------------------- | :------------------------------- | :------------------------------------------------------------------- | :------------------------------------------------------------------ | :---------------------------------------------- | :-------------------------------------------------- |
| **RDBMS**          |                                         |                                  |                                                                      |                                                                     |                                                 |
| MySQL              | ✔️                                      | ✔️                               | ✔️                                                                   | ✔️                                                                  | ✔️                                              | ✔️                                                  |
