...
| Feature            | [RBAC](/concepts/roles-and-permissions) | [Audit Log](/security/audit-log) | [External Secret Manager](/get-started/instance/#use-secret-manager) | [Query and Export Control](/security/database-permission/overview/) | [Data Masking](/security/data-masking/overview) |
| ------------------ | --------------------------------------- | -------------------------------- | -------------------------------------------------------------------- | ---------------------------------------------------------------- | ----------------------------------------------- |
| **RDBMS**          |                                         |                                  |                                                                      |                                                                  |                                                 |
| MySQL              | ✔️                                      | ✔️                               | ✔️                                                                   | ✔️                                                               | ✔️                                              |
| PostgreSQL         | ✔️                                      | ✔️                               | ✔️                                                                   | ✔️                                                               | ✔️                                              |
