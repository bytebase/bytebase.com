...
Bytebase offers [3 pricing plans](https://www.bytebase.com/pricing): `Free`, `Pro`, `Enterprise`. Both `Pro` and `Enterprise` plans require purchasing license. You can [contact us](https://www.bytebase.com/contact-us/) to require a 2-week free trial.
...
The price is based on the Plan and the purchased user and instance quota. To save budget, you can just purchase the instance quota covering a subset of your instances (e.g. only production instances).
