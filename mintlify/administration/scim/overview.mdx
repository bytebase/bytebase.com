...
Bytebase endpoint implements SCIM protocol, please make sure you have configured [External URL](/get-started/install/external-url) and it's network accessible from Entra.
