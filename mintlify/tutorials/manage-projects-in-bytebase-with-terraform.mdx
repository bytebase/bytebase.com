...
- A database named `demo` in your `mysql-test` instance

If you haven't created the Test project and `demo` database yet:
...
You can uncomment these lines in your `main.tf` to see all existing databases:
...
- Moves the database from the default "Test" project to this new project
...
Run `terraform apply` to create the project(s) and see them in action.
...
2. **Verify in Bytebase**:
   ...
   ![bb-projects-organized](/content/docs/tutorials/manage-databases-in-bytebase-with-terraform/bb-projects-organized.webp)
