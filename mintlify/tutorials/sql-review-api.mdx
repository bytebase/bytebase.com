...
You may call [Bytebase API](/api/sql-review/) in your internal portal or GitHub Actions to trigger SQL Review. Check out https://github.com/bytebase/example-api/tree/main/issue-creation
