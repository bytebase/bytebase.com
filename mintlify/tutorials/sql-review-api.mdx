...
Now you have learned how to trigger SQL Review in Bytebase API. You may also refer to the [SQL Review](/sql-review/overview) document for more details. Next, let's learn how to [codify SQL Review policies with API](/tutorials/api-sql-review-policy/)
