...
Above are some configurations including webhooks that you can set for a project. You can find the whole list of configurations [here](https://registry.terraform.io/providers/bytebase/bytebase/latest/docs/data-sources/project).

You may also config SQL review policies for a project. You can find the tutorial [here](/tutorials/manage-sql-review-rules-with-terraform).
...
1. Go to `Project One` and click **Settings**. You'll see the configurations you set.
