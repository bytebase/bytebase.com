...
- 👉 Part 7: Manage Database Access Control with Terraform - Define permissions
...
<Info>
  Bytebase has a hierarchical IAM system: - **Workspace Level**: Permissions apply to the entire
  workspace - **Project Level**: Permissions apply to specific projects only - **Conditional
  Access**: Fine-grained permissions for specific databases, schemas, and tables
</Info>
...
1. Go to **Project One** > **Manage > Members**:
   ...
   - Te`rraform Service Account`: `Project Owner` (as creator)
