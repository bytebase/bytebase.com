...
Go to **CI/CD > Plans** in the left menu. Click **+ New Plan**, select **Schema Migration**. Select both databases to **Edit Schema**, where you type in raw SQL code in the code block and click **Create** then click **Ready for Review**. Checks will automatically run and then you can go to **Rollout** tab to **Run**.
...
**Create** this issue and then **Ready for Review**. Checks will automatically run and then you can go to **Rollout** tab to **Run**.
