...
Let's continue with [Manage Users and Groups with Terraform](/tutorials/manage-users-and-groups-with-terraform) - configure users and groups for access control.
