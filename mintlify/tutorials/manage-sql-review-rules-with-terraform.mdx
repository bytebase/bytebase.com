...
<Tip>
  The examples below show some SQL Review rules. For a complete list of available rules and their configurations, see the [Terraform provider documentation](https://registry.terraform.io/providers/bytebase/bytebase/latest/docs/resources/review_config#nestedblock--rules).
</Tip>
