...
Above are SQL Review rules that you set for the `Prod` environment. You may set for a project instead of an environment using something like `bytebase_project.sample_project.name`.
