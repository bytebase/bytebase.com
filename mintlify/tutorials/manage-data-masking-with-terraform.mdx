...
<Info>
Bytebase uses two concepts for data masking:
...
Apply both semantic types and classification:
...
1. Click **Data Access > Data Classification** on the left sidebar.
1. You should see the classification hierarchy with two levels.
1. Note that Level 2 is marked as more sensitive.

![classification](/content/docs/tutorials/manage-data-masking-with-terraform/bb-classification.webp)

## Step 4: Create Global Masking Policy
...
This tutorial demonstrated how to implement comprehensive data masking in Bytebase using Terraform. Here are the key concepts:

<Info>
**Critical Relationship**: Classifications MUST be mapped to semantic types for masking to work.
