...
<Info>
  **Critical Relationship**: Classifications MUST be mapped to semantic types for masking to work. -
  Classifications define sensitivity levels (Level 1, Level 2, etc.) but cannot mask data by
  themselves - Semantic types define the actual masking algorithms (full-mask, range-mask, etc.) -
