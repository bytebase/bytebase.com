...
Semantic types define how data should be masked. Add these to your `main.tf`:
...
### Step 2 - Set Up Data Classification

Create a classification hierarchy for sensitive data:
...
### Step 3 - Create Global Masking Policy

Define workspace-wide masking rules:
...
### Step 4 - Configure Column Classification

To apply classification to specific database columns, you would update the column metadata in Bytebase:
...
### Step 5 - Grant Masking Exceptions

Allow specific users to bypass masking for certain operations:
...
- **Classification**: Organize data by sensitivity levels
- **Global Policies**: Apply masking rules workspace-wide
- **Column-Level Control**: Override with specific semantic types
