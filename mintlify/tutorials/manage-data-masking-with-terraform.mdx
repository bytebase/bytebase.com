...
Alternatively or additionally, create a classification hierarchy for sensitive data:
...
Define workspace-wide masking rules that automatically apply based on column names or classification levels. Notice how classification levels are mapped to semantic types:
...
Apply semantic types or classifications directly to specific database columns:
