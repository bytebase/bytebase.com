...
1. **Set up Bytebase admin account**:
...
1. **Use Built-in database instance**:

After registration, follow the guide to configure, you'll need the built-in sample instances.

![built-in-instance](/content/docs/tutorials/manage-bytebase-with-terraform/bb-use-built-in-sample.png)
...
Now you have learned how to use Terraform to manage your MySQL database environments and instances in Bytebase, for PostgreSQL, you can futher declare database roles. Please check more [advanced examples in GitHub](https://github.com/bytebase/terraform-provider-bytebase/tree/main/examples).

### Next in the Series

Continue to the next tutorial: [Manage Projects with Terraform](/tutorials/manage-projects-in-bytebase-with-terraform) where you'll learn how to organize your databases into projects for better management.
