...
- **ngrok**: [Sign up for ngrok](https://ngrok.com/) (or something similar)to expose your local Bytebase instance to the internet
...
1. Within Bytebase, click **IAM & Admin > Users & Groups** on the left sidebar, click **+ Add User**.
...
### Step 5 - Create Database Instances
