...
- Once you mark an environment as `protected`, Bytebase will attach a shield icon 🛡️ besides the environment name.
...
Continue with [Part 2: Manage Databases with Terraform](/tutorials/manage-databases-with-terraform) to connect and manage your database instances.
