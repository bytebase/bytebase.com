...
- **Completed [Part 1](/tutorials/manage-environments-with-terraform)**: Environments configured
...
Continue with [Part 3: Manage Projects with Terraform](/tutorials/manage-projects-with-terraform) to organize your databases into projects.
