...
| Usage                           | Bytebase                  | [External PostgreSQL](/get-started/install/external-postgres/) if used |
| ------------------------------- | ------------------------- | --------------------------------------------------------------------------- |
...
the Bytebase server runs. And if you use [External PostgreSQL](/get-started/install/external-postgres/),
...
SQL Editor autocomplete requires [enabling WebSocket](/get-started/self-host/#enable-websocket-for-sql-editor) in your gateway if present.
...
See [Production Setup](/administration/production-setup/).
...
See [Git Provider](/vcs-integration/add-git-provider).
