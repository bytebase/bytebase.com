...
While you **can not** [self-approve](/change-database/approval/) your own created issue, once
...
- [SQL Review violations](/sql-review/review-policy)
...
Bytebase requires the last approver from the activated [custom approval flow](/change-database/approval/) to deploy the change manually.
