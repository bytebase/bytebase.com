...
feature_image: /blog/introducing-mongodb-support-in-bytebase/cover.webp
tags: Announcement
...
![db-rank-3](/blog/introducing-mongodb-support-in-bytebase/db-rank-3.webp)
...
- Create an issue to create, update and delete documents in UI workflow and GitOps workflow. See the screenshot below to insert documents into the collection “student”.
  ![insert-doc](/blog/introducing-mongodb-support-in-bytebase/insert-doc.webp)

- Explore the migration history in the database details page.
  ![migration-his](/blog/introducing-mongodb-support-in-bytebase/migration-his.webp)

- Run mongosh commands in SQL Editor admin mode.
  ![admin-mode](/blog/introducing-mongodb-support-in-bytebase/admin-mode.webp)
