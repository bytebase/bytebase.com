...
1. **The demo page is stale**
   ...
   Our [live demo page](https://demo.bytebase.com) was deployed on AWS EC2 . There is an extra step to manually update it during each release.
...
### Continuous deployment for [our live demo](https://demo.bytebase.com)
