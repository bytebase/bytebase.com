...
feature_image: /blog/database-cicd-best-practice-with-github/database-cicd-best-practice-with-github.webp
tags: Tutorial
integrations: GitHub
level: Intermediate
...
![sql-review-gha](/blog/database-cicd-best-practice-with-github/sql-review-gha.webp)

![sql-review-actions](/blog/database-cicd-best-practice-with-github/sql-review-actions.webp)
...
![create-table-github](/blog/database-cicd-best-practice-with-github/create-table-github.webp)

![bytebase-vcs-issue](/blog/database-cicd-best-practice-with-github/bytebase-vcs-issue.webp)

## A Complete Database CI/CD Workflow

Here, we present **a complete Database CI/CD workflow**:

![database-devops-workflow](/blog/database-cicd-best-practice-with-github/database-devops-workflow.webp)
