...
- When creating your scripts, the SQL statements are pre-checked by Bytebase's [VCS-integrated review capabilities](/docs/sql-review/sql-advisor/gitops-ci) to help identify violations.
