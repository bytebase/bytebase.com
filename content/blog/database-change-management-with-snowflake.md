...
feature_image: /blog/database-change-management-with-snowflake/db-change-snowflake.webp
tags: Tutorial
...
2. Bytebase is running successfully in Docker, and you can visit it via `localhost:5678`.
   ![docker](/blog/database-change-management-with-snowflake/docker.webp)

3. Visit `localhost:5678` in your browser. Register the first admin account which will be granted `Workspace Owner`.
   ![bb-register](/blog/database-change-management-with-snowflake/bb-register.webp)
...
1. Visit `localhost:5678` and login as Workspace Owner.
   ![bb-login](/blog/database-change-management-with-snowflake/bb-login.webp)

2. Click **Add Instance**.
   ![bb-add-instance](/blog/database-change-management-with-snowflake/bb-add-instance.webp)

3. Add a Snowflake instance. You need to pay attention to some fields:
   ![bb-create-instance](/blog/database-change-management-with-snowflake/bb-create-instance.webp)
...
![sf-locator](/blog/database-change-management-with-snowflake/sf-locator.webp)

**Username and password**: The ones you use to log into your Snowflake account.
![sf-login](/blog/database-change-management-with-snowflake/sf-login.webp)
...
![sf-role-list](/blog/database-change-management-with-snowflake/sf-role-list.webp)
![sf-edit-user](/blog/database-change-management-with-snowflake/sf-edit-user.webp)
...
2. Click **New Project** to create a new project `TestSnowflake`, key is `TS`, mode is `standard`. Click **Create**.
   ![bb-new-project](/blog/database-change-management-with-snowflake/bb-new-project.webp)
...
1. After the project is created, go to the project and click **New DB**.
   ![bb-new-db](/blog/database-change-management-with-snowflake/bb-new-db.webp)
...
1. Fill the form with Name - `DB_DEMO_BB` (BB is short for Bytebase), Environment - `Test`, and Instance - `Snowflake instance`. Click **Create**.
   ![bb-create-db](/blog/database-change-management-with-snowflake/bb-create-db.webp)
...
1. Bytebase will create an issue “CREATE DATABASE ….” automatically. Because it’s for the `Test` environment, the issue will run without waiting for your approval by default. Click **Resolve**, and the issue is Done. The database is created.
   ![bb-go-home](/blog/database-change-management-with-snowflake/bb-go-home.webp)
...
1. Go back to the home page by clicking **Home** on the left sidebar. If it’s the first time you use Bytebase, it’ll show a celebration. On the home page, you can see the project, the database, and the issue you just resolved.
   ![bb-created-database](/blog/database-change-management-with-snowflake/bb-created-database.webp)
...
1. Go to project `TestSnowflake`, and click **Alter Schema**.
   ![bb-prj-alter-schema](/blog/database-change-management-with-snowflake/bb-prj-alter-schema.webp)
...
2. Choose `DB_DEMO_BB` and click **Next**. It could generate a pipeline if you have different databases for different environments.
   ![bb-alter-schema-test](/blog/database-change-management-with-snowflake/bb-alter-schema-test.webp)
...
![bb-is-new-create-table](/blog/database-change-management-with-snowflake/bb-is-new-create-table.webp)
...
4. Bytebase will do some basic checks and then execute the SQL. Since it’s for `Test` environment, the issue is automatically approved by default. Click **Resolve issue**.
   ![bb-is-create-table-run](/blog/database-change-management-with-snowflake/bb-is-create-table-run.webp)

5. The issue status will become Done.
   ![bb-is-create-table-done](/blog/database-change-management-with-snowflake/bb-is-create-table-done.webp)

6. On the issue page, click **view migration**. You will see diff for each migration.
   ![bb-view-migration](/blog/database-change-management-with-snowflake/bb-view-migration.webp)
...
7. You can also go to **Migration History** under the project to view the full history. Or go into a specific database to view its history.
   ![bb-prj-mh](/blog/database-change-management-with-snowflake/bb-prj-mh.webp)
   ![bb-db-mh](/blog/database-change-management-with-snowflake/bb-db-mh.webp)
...
![trial-14-days](/blog/database-change-management-with-snowflake/trial-14-days.webp)
...
1. Go to Snowflake, and add a COLUMN there. Make sure the new column is added.
   ![sf-alter-add-age](/blog/database-change-management-with-snowflake/sf-alter-add-age.webp)
...
2. Wait for 10 mins (as Bytebase does the check roughly every 10 mins). Go back to Bytebase, and you can find the Schema Drift on database DB_DEMO_BB
   ![bb-db-schema-drift](/blog/database-change-management-with-snowflake/bb-db-schema-drift.webp)

The Anomaly Center also surfaces the drift
![bb-ac-drift](/blog/database-change-management-with-snowflake/bb-ac-drift.webp)

3. Click **View diff**, you will see the exact drift.
   ![bb-view-drift](/blog/database-change-management-with-snowflake/bb-view-drift.webp)
...
4. Use baseline to reconcile the schema state from the live database schema. Go to DB_DEMO_BB > **Migration History** and click **Establish new baseline**.
   ![bb-db-establish-new-baseline](/blog/database-change-management-with-snowflake/bb-db-establish-new-baseline.webp)

5. It will create an issue. Click **Resolve** to make it done.
   ![bb-is-baseline-done](/blog/database-change-management-with-snowflake/bb-is-baseline-done.webp)

6. Go back to DB_DEMO_BB or Anomaly Center, and you will find the Drift is gone.
   ![bb-db-no-anomalies](/blog/database-change-management-with-snowflake/bb-db-no-anomalies.webp)
   ![bb-ac-no-anomaly](/blog/database-change-management-with-snowflake/bb-ac-no-anomaly.webp)
