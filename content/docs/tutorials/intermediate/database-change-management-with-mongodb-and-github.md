...
feature_image: /content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/feature-image.webp
tags: Tutorial
...
- [DevOps: Database Change Management with MongoDB](/docs/tutorials/beginner/database-change-management-with-mongodb)
- DevOps: Database Change Management with MongoDB and GitHub (this one)

---

In the last article [DevOps: Database Change Management with MongoDB](/docs/tutorials/beginner/database-change-management-with-mongodb), you have tried UI workflow in Bytebase.
...
- You have followed our previous UI-based change tutorial [DevOps: Database Change Management with MongoDB](/docs/tutorials/beginner/database-change-management-with-mongodb).
...
- You have a [ngrok](http://ngrok.com) account. ngrok is a reverse proxy tunnel, and in our case, we need it for a public network address in order to receive webhooks from GitHub.com. We use ngrok here for demonstration purposes. For production use, we recommend using [Caddy](https://caddyserver.com/).
  ![ngrok](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/ngrok.webp)
...
![terminal-ngrok](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/terminal-ngrok.webp)
...
5. Bytebase is running successfully in Docker, and you can visit it via `https://a664-154-9-204-35.ngrok.io`.
   ![docker](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/docker.webp)
...
1. Visit `https://a664-154-9-204-35.ngrok.io` in your browser, and log in using your admin account created from the previous article.
   ![bb-login](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/bb-login.webp)
...
1. Click **Settings** on the top bar, and then click **Workspace** > **GitOps**. Choose **GitHub.com** and click **Next**.
   ![bb-gitops-github-step1](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/bb-gitops-github-step1.webp)
...
3. Go to your GitHub account. Click **Settings** on the dropdown menu.
   ![gh-settings-dropdown](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/gh-settings-dropdown.webp)

4. Click **Developer Settings** at the bottom of the left side bar. Click **OAuth Apps**, and click **New OAuth App**.
   ![gh-oauth-apps](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/gh-oauth-apps.webp)
...
5. Fill **Application name** and then copy the **Homepage** and **Authorization callback URL** in Bytebase and fill them. Click **Register application**.
   ![gh-register-oauth](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/gh-register-oauth.webp)
...
6. After the OAuth application is created successfully. Click **Generate a new client secret**. Copy **Client ID** and this newly generated client secret and paste them back in Bytebase.
   ![gh-copy-client-id](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/gh-copy-client-id.webp)
   ![bb-gitops-github-step2](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/bb-gitops-github-step2.webp)
   ![gh-auth](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/gh-auth.webp)
...
7. Click **Next**. You will be redirected to the confirmation page. Click **Confirm and add**, and the Git provider is successfully added.
   ![bb-gitops-github-step3](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/bb-gitops-github-step3.webp)
...
1. Go to project `TestMongoDB`, click **GitOps**, and choose **GitOps Workflow**. Click **Configure GitOps**.
   ![bb-project-gitops-gitops-workflow](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/bb-project-gitops-gitops-workflow.webp)
...
2. Choose `GitHub.com` - the provider you just added. It will display all the repositories you can manipulate. Choose `mongodb-test-bb-local`.
   ![bb-project-gitops-github-repo](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/bb-project-gitops-github-repo.webp)
...
![vsc-test-sql](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/vsc-test-sql.webp)

2. Commit and push this file.
3. Go to Bytebase, and go into project `TestMongoDB`. You’ll find there is a new `Push Event` and a new `issue 106` created.
   ![bb-project-push](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/bb-project-push.webp)
...
![bb-issue-add-bella-done](/content/docs/tutorials/intermediate/database-change-management-with-mongodb-and-github/bb-issue-add-bella-done.webp)
