...
- [Database Change Management with MySQL](/docs/tutorials/beginner/database-change-management-with-mysql)
...
In the last article [Database Change Management with MySQL](/docs/tutorials/beginner/database-change-management-with-mysql), you have tried **UI workflow** in Bytebase.
...
- Finished our previous UI-based change tutorial [Database Change Management with MySQL](/docs/tutorials/beginner/database-change-management-with-mysql).
