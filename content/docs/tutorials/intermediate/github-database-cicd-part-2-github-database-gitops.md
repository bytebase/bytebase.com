...
feature_image: /docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/howto-github-2.webp
tags: Tutorial
integrations: GitHub
level: Intermediate
...
![divided-workflow](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/divided-workflow.webp)
...
![ngrok-reverse-proxy](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/ngrok-reverse-proxy.webp)
...
![ngrok](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/ngrok.webp)
...
![docker-running](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/docker-running.webp)
...
![bb-vc](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/bb-vc.webp)

2. Copy the **Authorization callback URL**.

![fill-id-secret](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/fill-id-secret.webp)

3. Open GitHub, and go to **Settings > Developer Settings > OAuth Apps**. Click **New OAuth App**.
   ![github-oauth](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/github-oauth.webp)

4. Scroll down on the new OAuth App page, paste the **Authorization callback URL**, then click **Update Application**.

![auth-callback](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/auth-callback.webp)

5. On the same page, you can also find **Client ID** and **Client secrets**.

![client-id-secrets](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/client-id-secrets.webp)
...
![confirm-and-add](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/confirm-and-add.webp)
...
![add-two-instances](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/add-two-instances.webp)
...
![transfer-in-db](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/transfer-in-db.webp)

![transfer-in-db-2](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/transfer-in-db-2.webp)

3. Go to **Version Control** under the project, and choose **GitOps workflow**.

![project-vc](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/project-vc.webp)

![project-vc-2](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/project-vc-2.webp)
...
![project-repo](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/project-repo.webp)

5. Click **Finish**, and you can see that Version Control is **enabled**.

![vc-enable](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/vc-enable.webp)

6. Create a **bytebase** folder and **prod**, **test** folders under it in your GitHub repository.

![bytebase-folder](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/bytebase-folder.webp)
...
![create-migration-sql](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/create-migration-sql.webp)

8. Commit and push this script.
9. Go back to the Bytebase Console, and you can see there is a new issue created.

![new-issue](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/new-issue.webp)
...
![issue-waiting](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/issue-waiting.webp)
![issue-done](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/issue-done.webp)

11. Go to database **employeeGitHub** > table **employee**, and the nickname column is added there.

![table-employee](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/table-employee.webp)
...
12. Switch to your code editor, and you will find there is an auto-generated file `.employeeGitHub##LATEST.sql`, which is the latest schema written back by Bytebase.
    ![latest](/docs/tutorials/intermediate/github-database-cicd-part-2-github-database-gitops/latest.webp)
