...
3. Make sure your Docker daemon is running, if it’s running Bytebase container for [the previous tutorial](/docs/tutorials/beginner/database-change-management-with-spanner), there're two ways:
...
7. Go back to Bytebase. Copy the **Client ID** and the newly generated **Client Secret**, paste them back into Bytebase's **Application ID** and **Secret**.
 ...
 ![bb-settings-gitops-step2](/docs/tutorials/intermediate/database-change-management-with-spanner-and-github/bb-settings-gitops-step2.webp)
...
4. Click `issue/107` and go to the issue page. The issue is `Done`. You’ll see:
   ...
   ![bb-issue-done](/docs/tutorials/intermediate/database-change-management-with-spanner-and-github/bb-issue-done.webp)
