...
feature_image: /docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/howto-github-1.webp
tags: Tutorial
integrations: GitHub
level: Intermediate
...
![divided-workflow](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/divided-workflow.webp)
...
![create-repo](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/create-repo.webp)

## Step 2 - Download the SQL review guide template

1. Go to [bytebase.com/sql-review-guide](/sql-review-guide), and choose **Dev**.

![sql-review-guide](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/sql-review-guide.webp)
...
![sql-review-guide-filter](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/sql-review-guide-filter.webp)
...
![move-template](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/move-template.webp)
...
![sql-review-actions](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/sql-review-actions.webp)

2. Configure the file to fit your need.

![configure-sql-review](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/configure-sql-review.webp)

## Step 4 - Open a PR (Pull Request) to trigger the SQL Review Github Actions

1. Create a new branch.

![new-branch](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/new-branch.webp)

2. Add a `.sql` file under the `github-action-test` folder.

![add-sql-review-sql](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/add-sql-review-sql.webp)

3. Commit and push, then create a PR on GitHub. The SQL review will run automatically.

![sql-review-run](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/sql-review-run.webp)

4. Click on **Actions** tab, and you will see there are two warnings regarding this particular SQL.

![sql-review-detail](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/sql-review-detail.webp)

5. Because they’re **warning** level, you can still merge the PR.

![sql-review-complete](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/sql-review-complete.webp)
...
![configure-guideline](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/configure-guideline.webp)

- Or edit the level field on the review rule list directly in your YAML file.

![edit-yaml](/docs/tutorials/github-database-cicd-part-1-sql-review-github-actions/edit-yaml.webp)
