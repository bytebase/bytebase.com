...
feature_image: /docs/tutorials/database-change-management-with-mysql/feature-image.webp
tags: Tutorial
integrations: MySQL
level: Beginner
...
- [Database Change Management with MySQL and GitHub](/docs/tutorials/database-change-management-with-mysql-and-github)
...
![docker](/docs/tutorials/database-change-management-with-mysql/docker.webp)

3. Visit `localhost:5678` in your browser. Register an account.
   ![register](/docs/tutorials/database-change-management-with-mysql/register.webp)
...
2. Click **Add Instance**.
   ![add-instance](/docs/tutorials/database-change-management-with-mysql/add-instance.webp)

3. Add a MySQL instance. Pay attention to these fields:
   ![create-instance](/docs/tutorials/database-change-management-with-mysql/create-instance.webp)
...
1. After the instance is created, go to the **Projects** tab, click on **New Project** to create a new project.
   ![create-project](/docs/tutorials/database-change-management-with-mysql/create-project.webp)
...
1. After the project is created. Click on **New DB** to create a new database.
   ![new-db](/docs/tutorials/database-change-management-with-mysql/new-db.webp)

2. Fill the form, and pay attention to these fields:
   ![create-db](/docs/tutorials/database-change-management-with-mysql/create-db.webp)
...
![create-issue](/docs/tutorials/database-change-management-with-mysql/create-issue.webp)
...
![alter-schema](/docs/tutorials/database-change-management-with-mysql/alter-schema.webp)
...
![schema-editor](/docs/tutorials/database-change-management-with-mysql/schema-editor.webp)
...
![issue-diff](/docs/tutorials/database-change-management-with-mysql/issue-diff.webp)
...
![mysql-add-column](/docs/tutorials/database-change-management-with-mysql/mysql-add-column.webp)
...
![schema-drift](/docs/tutorials/database-change-management-with-mysql/schema-drift.webp)

3. Click on **View diff**, you will see the exact drift.
   ![diff](/docs/tutorials/database-change-management-with-mysql/diff.webp)
...
![establish-baseline](/docs/tutorials/database-change-management-with-mysql/establish-baseline.webp)

4. Bytebase will create an issue to establish the new baseline, click **Create**, and then **Resolve** to mark it done.
   ![establish-baseline-issue](/docs/tutorials/database-change-management-with-mysql/establish-baseline-issue.webp)

5. Go back to your database page, where you will find the drift is gone and no anomalies detected.
   ![no-anomalies](/docs/tutorials/database-change-management-with-mysql/no-anomalies.webp)
