...
![ngrok](/content/docs/tutorials/database-change-management-with-tidb-and-github/ngrok.webp)
...
2. Run`ngrok http 5678` and obtain the public URL:
   ![terminal-ngrok](/content/docs/tutorials/database-change-management-with-tidb-and-github/terminal-ngrok.webp)
...
4. Bytebase is running successfully in Docker, and you can visit it via `https://df8d-154-9-204-36.ap.ngrok.io`
   ![docker](/content/docs/tutorials/database-change-management-with-tidb-and-github/docker.webp)
