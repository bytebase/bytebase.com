...
- **Auth style** specifies how the endpoint wants the client ID & client secret sent.
  ...
  - **In header**: The `client_id` and `client_password` will be sending using HTTP Basic Authorization. This is an optional style described in the OAuth2 RFC 6749 section 2.3.1.
