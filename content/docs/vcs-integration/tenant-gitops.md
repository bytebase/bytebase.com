...
To practice GitOps with [batch change](/docs/change-database/batch-change/), you need to enable the [VCS Integration](/docs/vcs-integration/overview) for your selected project, then use the VCS repository instead of our UI to organize and propose schema and data changes.
