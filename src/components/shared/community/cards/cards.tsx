...
const Card = ({
  ...
  return (
    <NextLink href={href}>
      <article
        className={clsx(
          'group flex h-full flex-col items-center border border-solid p-9 pb-14 transition-shadow duration-300 3xl:p-8 xl:px-6 xl:py-7 md:px-5 sm:h-auto sm:items-start sm:px-6 sm:pb-5',
          {
