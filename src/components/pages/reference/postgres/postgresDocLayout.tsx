...
export default function PostgresDocLayout({
  children,
  dirPath,
}: {
    ...
    <>
      ...
      <div className="mx-auto w-full max-w-[1920px] px-10 sm:px-4">
        <div className="grid grid-cols-5 gap-x-10 pt-8 xl:gap-x-9 lg:gap-x-6 md:mt-6 md:gap-x-5 sm:gap-x-4">
          ...
          before:absolute before:left-0 before:top-0 before:z-10 before:w-full before:bg-docs-sidebar 
          ...
          md:hidden"
          >
            <Sidebar data={sidebar} expandedList={expandedList} includeSearch={false} />
          </div>
