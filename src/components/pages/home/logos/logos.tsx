...
const Logos = () => {
  return (
    <section className="mt-20 bg-[radial-gradient(50%_50%_at_50%_50%,rgba(255,255,255,0)34.28%,rgba(240,242,255,0.5)100%)] py-16 2xl:mt-16 2xl:py-16 xl:mt-14 xl:py-12 md:mt-10 md:py-10 sm:mt-6 sm:py-4">
