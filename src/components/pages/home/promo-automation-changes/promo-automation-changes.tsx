    ...
    >
      <div className="container gap-x-grid grid grid-cols-12 md:grid-cols-none">
        <div className="col-start-1 col-end-5 py-[175px] 3xl:py-40 xl:col-end-6 xl:py-[140px] md:col-auto md:py-0 md:pt-16 sm:pt-[60px]">
          ...
          <p className="-mr-10 mt-8 text-20 leading-normal xl:mr-0 xl:mt-5 xl:text-18 xl:leading-snug md:mt-4 md:max-w-xl md:text-16 sm:mt-3 sm:max-w-none">
            Bytebase streamlines database change deployment from non-prod to prod with review
            workflow, rollback, and optional GitOps integration.
          </p>
          <LinkUnderlined
        ...
        <div
          className="relative col-start-5 col-end-13 self-stretch pt-[100px] before:absolute before:bottom-0 before:right-[166px] before:top-0 before:w-[252px] before:bg-automation-changes 3xl:pt-[84px] 3xl:before:right-10 xl:col-start-6 xl:pt-[115px] xl:before:right-5 xl:before:w-[216px] md:col-auto md:-mx-7 md:pb-10 md:pt-10 md:before:right-0 md:before:top-auto md:before:h-[315px] md:before:w-full md:before:bg-automation-changes-phone sm:-mx-4 sm:pb-7 sm:pt-[30px] sm:before:h-[260px]"
          ref={animationRef}
        >
          <div
