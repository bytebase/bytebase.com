...
export default function Page() {
  return (
    <div className="container gap-x-grid relative grid grid-cols-12 lg:grid-cols-1">
      ...
      <div className="col-span-6 col-start-7 row-span-4 grid w-[800px] grid-cols-2 gap-x-6 gap-y-6 rounded-2xl bg-white p-8 shadow-dark-big 2xl:col-span-7 2xl:col-start-6 2xl:gap-x-[22px] 2xl:p-7 2xl:pb-8 xl:gap-x-4 xl:gap-y-5 xl:p-6 lg:col-span-full lg:mt-8 lg:gap-x-6 lg:gap-y-6 lg:p-8 md:mt-6 md:grid-cols-1 md:gap-y-5 md:px-4 md:py-7">
        <CalForm />
      </div>
      <Logos />
    </div>
