...
const Promo = () => {
  const aside = PROMO_DATA.DOC_ASIDE;
  ...
  return (
    ...
    >
      ...
      <span className="mt-4 flex h-9 w-[144px] items-center justify-center rounded-full bg-gray-15 text-13 font-bold uppercase tracking-wide text-white">
        {aside.cta}
      </span>
    </Link>
  );
