...
In the [previous tutorial](/tutorials/github-action-data-masking-part1), you learned how to set up a GitHub Action that utilizes the Bytebase API to define semantic types and global masking rule. In this tutorial, we will explore how to apply column masking and masking exemption.
...
[Column Masking](/security/data-masking/column-masking/) lets you specify table columns different semantic type to mask the data differently.
...
[Masking Exemption](/security/data-masking/access-unmasked-data) lets you exempt users from data masking and see the unmasked data.
...
<Card title="Next Step: Data Classification" icon="book" href="/tutorials/github-action-data-masking-part3" horizontal />