...
Bytebase's Schema Diagram provides a database ER Diagram.
...
While using [Schema Editor](/change-database/schema-editor), you may also preview the database schema and changes via Schema Diagram. Click the **Schema Diagram** and you will switch to the Schema Diagram tab.
